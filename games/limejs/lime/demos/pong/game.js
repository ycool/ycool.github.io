...
pong.Game = function(mode) {
    ...
    this.world = new lime.Sprite().setFill('#EEE').setSize(this.WIDTH, this.HEIGHT).setPosition(10, 50).
        setAnchorPoint(0, 0);
...
pong.Game.prototype.start = function() {
    console.log('in pong.Game.prototype.start');
...
pong.Game.prototype.placeball = function() {
    console.log('pong.Game.prototype.placeball');
...
pong.Game.prototype.endGame = function() {
    console.log('pong.Game.prototype.endGame');
...
pong.Game.prototype.endRound = function(winner) {
    console.log('pong.Game.prototype.endRound');
